...
extern volatile int app2_flags; //for server_2 status
...
//defined for SERVER_2
#define APP_FLAG2(flag) (app2_flags & flag)

#define APP_FLAG_SET2(flag) (app2_flags |= flag)
#define APP_FLAG_CLEAR2(flag) (app2_flags &= ~flag)
